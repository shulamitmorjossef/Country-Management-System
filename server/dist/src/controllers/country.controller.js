...
exports.remove = exports.update = exports.getOne = exports.getAll = exports.create = exports.catchAsync = void 0;
const country_service_1 = require("../services/country.service");
const catchAsync = (fn) => (req, res, next) => {
    fn(req, res, next).catch(next);
};
exports.catchAsync = catchAsync;
exports.create = (0, exports.catchAsync)(async (req, res) => {
    const country = await (0, country_service_1.createCountry)(req.body);
    res.status(201).json(country);
});
exports.getAll = (0, exports.catchAsync)(async (req, res) => {
    const countries = await (0, country_service_1.getAllCountries)();
    res.json(countries);
});
exports.getOne = (0, exports.catchAsync)(async (req, res) => {
...
exports.update = (0, exports.catchAsync)(async (req, res) => {
...
exports.remove = (0, exports.catchAsync)(async (req, res) => {
